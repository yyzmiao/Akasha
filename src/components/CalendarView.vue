<template>
  <div class="flex-1 min-h-0 flex flex-col space-y-2.5 sm:space-y-3">
    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- Desktop Only: Detailed Pills (Capped at 3-4 items, delicate space-y-0.5 sm:space-y-1) -->
          <div class="hidden sm:flex flex-col space-y-0.5 sm:space-y-1 flex-1 min-h-0 overflow-hidden">
